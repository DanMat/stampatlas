...
function frontispiece(){
  ...
  return \`<section class="front" id="top"><div class="wrap">
    <div>
      ...
      <div class="bigfacts">
        <div class="bf" title="Every stamp a person counted by hand across the photographed pages — one confirmed count per page. A page left blank takes the machine's page count; an empty page counts as zero. This is the ground truth the machine's reading is measured against."><div class="n">\${countedN?fmt(countedN):"—"}</div><div class="l">\${countedN?"counted by hand":"awaiting the count"}</div></div>
      ...
      <p class="small muted" style="margin-top:12px;max-width:54ch"><em>Counted by hand</em> is the truth; the other two are the machine's <em>candidate</em> readings. As the reader improves year on year, its counts should close on the hand count — the gap is the work left to do.</p>
    </div>
