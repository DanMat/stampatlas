...
function homePage(){ return frontispiece()+glanceBand()+candidatesBand()+issuersBand()+themesBand()+peopleBand()+SUBFACETS.map(subfacetBand).join("")+territoriesBand()+formsBand()+moneyBand()+todayBand()+mapBand()+doorsBand()+recentBand(); }
